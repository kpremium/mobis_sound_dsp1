...
extern uint32_t sPDMA_AMP__I_Buf[NUM_IN_OUT_BLOCKS*NUM_A2B_SAMPLES*NUM_IP_CHANNELS_A2B];
extern uint32_t sPDMA_AMP__O_Buf[NUM_IN_OUT_BLOCKS*NUM_A2B_SAMPLES*NUM_OP_CHANNELS_A2B];
extern uint32_t sPDMA_ACC1_I_Buf[NUM_IN_OUT_BLOCKS*NUM_A2B_SAMPLES*NUM_IP_CHANNELS_ACC1];
extern uint32_t sPDMA_PMIC_I_Buf[NUM_IN_OUT_BLOCKS*NUM_A2B_SAMPLES*NUM_IP_CHANNELS_PMIC];
extern uint32_t sPDMA_IPC__I_Buf[NUM_IN_OUT_BLOCKS*NUM_A2B_SAMPLES*NUM_IP_CHANNELS_DSP];
extern uint32_t sPDMA_IPC__O_Buf[NUM_IN_OUT_BLOCKS*NUM_A2B_SAMPLES*NUM_OP_CHANNELS_DSP];
extern uint32_t sPDMA_VESS_O_Buf[NUM_IN_OUT_BLOCKS*NUM_A2B_SAMPLES*NUM_OP_CHANNELS_VESS];
extern uint32_t sPDMA_CAMP_I_Buf[NUM_IN_OUT_BLOCKS*NUM_A2B_SAMPLES*NUM_IP_CHANNELS_CAMPING];
extern uint32_t sPDMA_CAMP_O_Buf[NUM_IN_OUT_BLOCKS*NUM_A2B_SAMPLES*NUM_OP_CHANNELS_CAMPING];
...
{
	{
		...
		.XCount = NUM_IP_CHANNELS_A2B,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
		.YModify = ( ((-1)*NUM_A2B_SAMPLES*(NUM_IP_CHANNELS_A2B-1))+1)*4,
	},
	{
		.pNextDscp = (void *)((uint32_t)&gSPORT0ADscp[0]+ MEM_SPACE_SYS_OFFSET),
		.pStartAddr = (uint32_t *)((uint32_t)&sPDMA_AMP__I_Buf[NUM_A2B_SAMPLES*NUM_IP_CHANNELS_A2B] + MEM_SPACE_SYS_OFFSET),
		.Config = ENUM_DMA_CFG_DSCLIST | ENUM_DMA_CFG_FETCH07 | ENUM_DMA_CFG_ADDR2D | ENUM_DMA_CFG_YCNT_INT | ENUM_DMA_CFG_PSIZE04 | ENUM_DMA_CFG_MSIZE04 | ENUM_DMA_CFG_WRITE |ENUM_DMA_CFG_EN,
		.XCount = NUM_IP_CHANNELS_A2B,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
...
{
	{
		...
		.XCount = NUM_OP_CHANNELS_A2B,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
		.YModify = ( ((-1)*NUM_A2B_SAMPLES*(NUM_OP_CHANNELS_A2B-1))+1)*4,
	},
	{
		.pNextDscp = (void *)((uint32_t)&gSPORT0BDscp[0]+ MEM_SPACE_SYS_OFFSET),
		.pStartAddr = (uint32_t *)((uint32_t)&sPDMA_AMP__O_Buf[NUM_A2B_SAMPLES*NUM_OP_CHANNELS_A2B] + MEM_SPACE_SYS_OFFSET),
		.Config = ENUM_DMA_CFG_DSCLIST | ENUM_DMA_CFG_FETCH07 | ENUM_DMA_CFG_ADDR2D | ENUM_DMA_CFG_YCNT_INT | ENUM_DMA_CFG_PSIZE04 | ENUM_DMA_CFG_MSIZE04 | ENUM_DMA_CFG_EN,
		.XCount = NUM_OP_CHANNELS_A2B,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
...
{
	{
		...
		.Config = ENUM_DMA_CFG_DSCLIST | ENUM_DMA_CFG_FETCH07 | ENUM_DMA_CFG_ADDR2D | ENUM_DMA_CFG_YCNT_INT | ENUM_DMA_CFG_PSIZE04 | ENUM_DMA_CFG_MSIZE04 | ENUM_DMA_CFG_WRITE |ENUM_DMA_CFG_EN,
		.XCount = NUM_IP_CHANNELS_ACC1,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
		.YModify = ( ((-1)*NUM_A2B_SAMPLES*(NUM_IP_CHANNELS_ACC1-1))+1)*4,
	},
	{
		.pNextDscp = (void *)((uint32_t)&gSPORT2ADscp[0]+ MEM_SPACE_SYS_OFFSET),
		.pStartAddr = (uint32_t *)((uint32_t)&sPDMA_ACC1_I_Buf[NUM_A2B_SAMPLES*NUM_IP_CHANNELS_ACC1] + MEM_SPACE_SYS_OFFSET),
		.Config = ENUM_DMA_CFG_DSCLIST | ENUM_DMA_CFG_FETCH07 | ENUM_DMA_CFG_ADDR2D | ENUM_DMA_CFG_YCNT_INT | ENUM_DMA_CFG_PSIZE04 | ENUM_DMA_CFG_MSIZE04 | ENUM_DMA_CFG_WRITE |ENUM_DMA_CFG_EN,
		.XCount = NUM_IP_CHANNELS_ACC1,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
...
{
	{
		...
		.Config = ENUM_DMA_CFG_DSCLIST | ENUM_DMA_CFG_FETCH07 | ENUM_DMA_CFG_ADDR2D | ENUM_DMA_CFG_YCNT_INT | ENUM_DMA_CFG_PSIZE04 | ENUM_DMA_CFG_MSIZE04 | ENUM_DMA_CFG_WRITE |ENUM_DMA_CFG_EN,
		.XCount = NUM_IP_CHANNELS_PMIC,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
		.YModify = ( ((-1)*NUM_A2B_SAMPLES*(NUM_IP_CHANNELS_PMIC-1))+1)*4,
	},
	{
		.pNextDscp = (void *)((uint32_t)&gSPORT3ADscp[0] + MEM_SPACE_SYS_OFFSET),
		.pStartAddr = (uint32_t *)((uint32_t)&sPDMA_PMIC_I_Buf[NUM_A2B_SAMPLES*NUM_IP_CHANNELS_PMIC] + MEM_SPACE_SYS_OFFSET),
		.Config = ENUM_DMA_CFG_DSCLIST | ENUM_DMA_CFG_FETCH07 | ENUM_DMA_CFG_ADDR2D | ENUM_DMA_CFG_YCNT_INT | ENUM_DMA_CFG_PSIZE04 | ENUM_DMA_CFG_MSIZE04 | ENUM_DMA_CFG_WRITE |ENUM_DMA_CFG_EN,
		.XCount = NUM_IP_CHANNELS_PMIC,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
...
{
	{
		...
		.Config = ENUM_DMA_CFG_DSCLIST | ENUM_DMA_CFG_FETCH07 | ENUM_DMA_CFG_ADDR2D | ENUM_DMA_CFG_YCNT_INT | ENUM_DMA_CFG_PSIZE04 | ENUM_DMA_CFG_MSIZE04 | ENUM_DMA_CFG_EN,
		.XCount = NUM_OP_CHANNELS_DSP,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
		.YModify = ( ((-1)*NUM_A2B_SAMPLES*(NUM_OP_CHANNELS_DSP-1))+1)*4,
	},
	{
		.pNextDscp = (void *)((uint32_t)&gSPORT4ADscp[0] + MEM_SPACE_SYS_OFFSET),
		.pStartAddr = (uint32_t *)((uint32_t)&sPDMA_IPC__O_Buf[NUM_A2B_SAMPLES*NUM_OP_CHANNELS_DSP] + MEM_SPACE_SYS_OFFSET),
		.Config = ENUM_DMA_CFG_DSCLIST | ENUM_DMA_CFG_FETCH07 | ENUM_DMA_CFG_ADDR2D | ENUM_DMA_CFG_YCNT_INT | ENUM_DMA_CFG_PSIZE04 | ENUM_DMA_CFG_MSIZE04 | ENUM_DMA_CFG_EN,
		.XCount = NUM_OP_CHANNELS_DSP,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
...
{
	{
		...
		.Config = ENUM_DMA_CFG_DSCLIST | ENUM_DMA_CFG_FETCH07 | ENUM_DMA_CFG_ADDR2D | ENUM_DMA_CFG_YCNT_INT | ENUM_DMA_CFG_PSIZE04 | ENUM_DMA_CFG_MSIZE04 | ENUM_DMA_CFG_WRITE |ENUM_DMA_CFG_EN,
		.XCount = NUM_IP_CHANNELS_DSP,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
		.YModify = ( ((-1)*NUM_A2B_SAMPLES*(NUM_IP_CHANNELS_DSP-1))+1)*4,
	},
	{
		.pNextDscp = (void *)((uint32_t)&gSPORT4BDscp[0] + MEM_SPACE_SYS_OFFSET),
		.pStartAddr = (uint32_t *)((uint32_t)&sPDMA_IPC__I_Buf[NUM_A2B_SAMPLES*NUM_IP_CHANNELS_DSP] + MEM_SPACE_SYS_OFFSET),
		.Config = ENUM_DMA_CFG_DSCLIST | ENUM_DMA_CFG_FETCH07 | ENUM_DMA_CFG_ADDR2D | ENUM_DMA_CFG_YCNT_INT | ENUM_DMA_CFG_PSIZE04 | ENUM_DMA_CFG_MSIZE04 | ENUM_DMA_CFG_WRITE |ENUM_DMA_CFG_EN,
		.XCount = NUM_IP_CHANNELS_DSP,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
...
{
	{
		...
		.XCount = NUM_OP_CHANNELS_CAMPING,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
		.YModify = ( ((-1)*NUM_A2B_SAMPLES*(NUM_OP_CHANNELS_CAMPING-1))+1)*4,
	},
	{
		.pNextDscp = (void *)((uint32_t)&gSPORT6BDscp[0] + MEM_SPACE_SYS_OFFSET),
		.pStartAddr = (uint32_t *)((uint32_t)&sPDMA_CAMP_O_Buf[NUM_A2B_SAMPLES*NUM_OP_CHANNELS_CAMPING] + MEM_SPACE_SYS_OFFSET),
		.Config = ENUM_DMA_CFG_DSCLIST | ENUM_DMA_CFG_FETCH07 | ENUM_DMA_CFG_ADDR2D | /*ENUM_DMA_CFG_YCNT_INT |*/ ENUM_DMA_CFG_PSIZE04 | ENUM_DMA_CFG_MSIZE04 | ENUM_DMA_CFG_SYNC | ENUM_DMA_CFG_EN,
		.XCount = NUM_OP_CHANNELS_CAMPING,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
...
{
	{
		...
		.Config = ENUM_DMA_CFG_DSCLIST | ENUM_DMA_CFG_FETCH07 | ENUM_DMA_CFG_ADDR2D | ENUM_DMA_CFG_YCNT_INT | ENUM_DMA_CFG_PSIZE04 | ENUM_DMA_CFG_MSIZE04 | ENUM_DMA_CFG_SYNC | ENUM_DMA_CFG_EN,
		.XCount = NUM_OP_CHANNELS_VESS,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
		.YModify = ( ((-1)*NUM_A2B_SAMPLES*(NUM_OP_CHANNELS_VESS-1))+1)*4,
	},
	{
		.pNextDscp = (void *)((uint32_t)&gSPORT7ADscp[0] + MEM_SPACE_SYS_OFFSET),
		.pStartAddr = (uint32_t *)((uint32_t)&sPDMA_VESS_O_Buf[NUM_A2B_SAMPLES*NUM_OP_CHANNELS_VESS] + MEM_SPACE_SYS_OFFSET),
		.Config = ENUM_DMA_CFG_DSCLIST | ENUM_DMA_CFG_FETCH07 | ENUM_DMA_CFG_ADDR2D | ENUM_DMA_CFG_YCNT_INT | ENUM_DMA_CFG_PSIZE04 | ENUM_DMA_CFG_MSIZE04 | ENUM_DMA_CFG_SYNC | ENUM_DMA_CFG_EN,
		.XCount = NUM_OP_CHANNELS_VESS,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
...
{
	{
		...
		.XCount = NUM_IP_CHANNELS_CAMPING,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
		.YModify = ( ((-1)*NUM_A2B_SAMPLES*(NUM_IP_CHANNELS_CAMPING-1))+1)*4,
	},
	{
		.pNextDscp = (void *)((uint32_t)&gSPORT7BDscp[0] + MEM_SPACE_SYS_OFFSET),
		.pStartAddr = (uint32_t *)((uint32_t)&sPDMA_CAMP_I_Buf[NUM_A2B_SAMPLES*NUM_IP_CHANNELS_CAMPING] + MEM_SPACE_SYS_OFFSET),
		.Config = ENUM_DMA_CFG_DSCLIST | ENUM_DMA_CFG_FETCH07 | ENUM_DMA_CFG_ADDR2D | ENUM_DMA_CFG_YCNT_INT | ENUM_DMA_CFG_PSIZE04 | ENUM_DMA_CFG_MSIZE04 | ENUM_DMA_CFG_WRITE | ENUM_DMA_CFG_SYNC | ENUM_DMA_CFG_EN,
		.XCount = NUM_IP_CHANNELS_CAMPING,
		.XModify = NUM_A2B_SAMPLES*4,
		.YCount = NUM_A2B_SAMPLES,
